...
if __name__ == "__main__":
    ...
    cache_ref_fn = os.path.join(os.path.dirname(args.dataset), os.path.basename(args.dataset)[:-4] + "_prop.pkl")
    ...
    cache_gen_fn = os.path.join(os.path.dirname(args.generated), os.path.basename(args.generated)[:-4] + "_prop.pkl")
